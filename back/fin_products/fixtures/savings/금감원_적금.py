...
def fetch_and_convert_to_json(topFinGrpNo, pageNo, products_json_filename, options_json_filename):
    ...
    while is_continue:
        ...
        for product in products:
            product_records = {
                'model': 'fin_products.savingproduct',
        ...
        for option in options:
            option_records = {
                'model': 'fin_products.savingoption',
                ...
                'fields': {
                    ...
                    'rsrv_type': option.get('rsrv_type_nm', None),
                    'rsrv_type_nm': option.get('rsrv_type_nm', None),
...
if __name__ == "__main__":
    ...
    for topFinGrpNo in topFinGrpNo_list:
        fetch_and_convert_to_json(topFinGrpNo, 1, "saving_products.json", "saving_options.json")
